...
public class ConfigResolver {
    ...
    private SlideData loadSlideConfig(XSLFSlide slide, Map<String, Object> paramsMap) throws IOException {
        ...
        for (XSLFShape shape : shapeList) {
            ...
            if (shape instanceof XSLFTable) {
                List<TableRow> tempList = getDataMap((XSLFTable) shape);
                TableData tableData = new TableData();
                tableData.setTableRowList(tempList);
     ...
     * @return
     */
    public List<TableRow> getDataMap(XSLFTable table) {
     ...
     * @since hui_project 1.0.0
     */
    private List<TableRow> analysisTableData(List<Map<String, Object>> sqlDataList){
        ...
        for (Map<String, Object> stringObjectMap : sqlDataList) {
            ...
            tableData.setCellList(dataList);
